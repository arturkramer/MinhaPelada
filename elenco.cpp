...
void elenco::editarNome(int pos, QString value)
{
    Elenco[pos].setNome(value);
}

void elenco::editarMatricula(int pos, QString value)
{
    Elenco[pos].setMatricula(value);
}

void elenco::editarNumero(int pos, int value)
{
    Elenco[pos].setNumero(value);
}
